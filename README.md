...
getstats.sh
The getstats.shScript membantu masalah diagnosa dengan OpenWRT. Jika Anda melaporkan masalah, selalu membantu untuk menyertakan output dari skrip ini.
...
-aku | --idle: Jangan mengirim lalu lintas, hanya ukur latensi menganggur
